...
subtitle:       Automated Streaming App
author:         Nathan Couturier
module:         G-EIP-700
version:        1.2
---
...
| F7             | A user determine if the amount of proposed camera switch and their consistency is relevant of an action    |                                                                                                                                              | To be evaluated |
| F8             | A user determine if the amount of automatised camera switch and their consistency is relevant of an action |                                                                                                                                              | To be evaluated |
